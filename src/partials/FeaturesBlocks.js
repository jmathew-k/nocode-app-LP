			...
			<div className='relative max-w-6xl mx-auto px-4 sm:px-6'>
				<div className='py-12 md:py-20'>
					...
					<div className='max-w-3xl mx-auto text-center pb-12 md:pb-20'>
						<h2 className='h4 mb-4'>Industry Solutions</h2>
						<p className='text-base text-gray-600'>
							Tesseract is solving many of the problems that have held back blockchain technology so far — all in one place, without compromising
						</p>
					</div>
					...
					<div className='max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none'>
						...
						<div className='relative flex flex-col items-center p-6 bg-white rounded shadow-xl'>
							...
							>
								<g fill='none' fillRule='evenodd'>
									...
									<g strokeWidth='2'>
										<path
											className='stroke-current text-teal-200'
							...
							<p className='text-gray-600 text-center text-sm'>
								Access and engage in the DeFi ecosystem
							</p>
						</div>
						...
						<div className='relative flex flex-col items-center p-6 bg-white rounded shadow-xl'>
							...
							<p className='text-gray-600 text-center text-sm'>
								Issue & manage digital assets and instruments
							</p>
						</div>
						...
						<div className='relative flex flex-col items-center p-6 bg-white rounded shadow-xl'>
							...
							<p className='text-gray-600 text-center text-sm'>
								Streamline retail and wholesale payments infrastructure
							</p>
						</div>
					</div>
				</div>
